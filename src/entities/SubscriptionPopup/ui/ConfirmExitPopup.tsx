        ...
        <div className="bg-white rounded-[20px] shadow-2xl p-6 relative">
          ...
          <div className="mt-[58px] text-center">
            ...
            <div className="flex flex-row gap-x-2 mt-[36px]">
              <button
                onClick={onCancel}
                className="h-[52px] w-[143px] rounded-[8px] bg-[#F4F4F4] text-[#0B0911] hover:bg-[#E9EAEE] transition text-[18px] font-[400] cursor-pointer"
              >
                Отказаться
              </button>
              <button
                onClick={onConfirm}
                className="h-[52px] w-[251px] rounded-[8px] text-white bg-[#BBA2FE] hover:brightness-95 cursor-pointer transition text-[18px] font-[400]"
              >
